...
<body>
<div id="splash">
		<div id="splash-logo">心臓は１日にすると約10万回拍動しています</div>
		<!--/splash-->
	</div>
...
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<div class="liverhome">
		<marquee scrollamount="7">
			<strong>HEART</strong> <strong>HEART</strong> <strong>HEART</strong>
		</marquee>
	</div>
	
	
	<div class="search">
	<form action="../../heartsearch/heartsearch" method="post">
	検索<input type="text" name="keywordHeart">
