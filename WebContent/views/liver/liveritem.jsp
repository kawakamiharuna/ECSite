...
<body>
<div id="splash">
		<div id="splash-logo">コーヒーは肝がんの予防につながると考えられている</div>
		<!--/splash-->
	</div>
...
<%@page contentType="text/html; charset=UTF-8"%>
	...
	<div class="liverhome">
		<marquee scrollamount="7">
			<strong>LIVER</strong> <strong>LIVER</strong> <strong>LIVER</strong>
		</marquee>
	</div>
	
	<div class="search">
	<form action="../../liversearch/liversearch" method="post">
	検索<input type="text" name="keywordLiver">
