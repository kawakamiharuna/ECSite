...
<body>
<div id="splash">
		<div id="splash-logo">筋肉は全身に約600個存在する</div>
		<!--/splash-->
	</div>
...
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<div class="liverhome">
		<marquee scrollamount="8">
			<strong>MUSCLE</strong> <strong>MUSCLE</strong> <strong>MUSCLE</strong>
		</marquee>
	</div>
	<div class="search">
	<form action="../../musclesearch/musclesearch"  method="post">
	検索<input type="text" name="keywordMuscle">
